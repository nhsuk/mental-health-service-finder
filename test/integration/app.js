...
describe('Application behaviour', () => {
  ...
  it('should have or have not headers for security', async () => {
    ...
    expect(res).to.have.header('Content-Security-Policy', 'connect-src \'self\' api.nhs.uk assets.adobedtm.com *.azure-api.net *.demdex.net *.hotjar.com:* *.google-analytics.com nhs.funnelback.co.uk; default-src \'self\'; font-src \'self\' *.nhs.uk *.hotjar.com; frame-src *.hotjar.com; img-src \'self\' data: *.2o7.net *.everesttech.net *.google-analytics.com *.hotjar.com *.nhs.uk *.omtrdc.net; script-src \'self\' \'unsafe-eval\' \'unsafe-inline\' data: assets.adobedtm.com *.demdex.net *.google-analytics.com *.hotjar.com *.nhs.uk; style-src \'self\' \'unsafe-inline\' *.nhs.uk; worker-src *.hotjar.com');
