...
describe('Application behaviour', () => {
  ...
  it('should have or have not headers for security', async () => {
    ...
    expect(res).to.have.header('Content-Security-Policy', 'connect-src \'self\' *.hotjar.com:* *.google-analytics.com nhs.funnelback.co.uk nhsukpoc.search.windows.net; default-src \'self\'; font-src \'self\' *.nhs.uk *.hotjar.com; frame-src *.hotjar.com; img-src \'self\' data: *.google-analytics.com *.hotjar.com *.webtrends.com *.webtrendslive.com *.nhs.uk; script-src \'self\' \'unsafe-eval\' \'unsafe-inline\' data: *.google-analytics.com *.hotjar.com *.webtrends.com *.webtrendslive.com; style-src \'self\' \'unsafe-inline\' *.nhs.uk; worker-src *.hotjar.com');
