...
describe('Application behaviour', () => {
  ...
  it('should have or have not headers for security', async () => {
    ...
    expect(res).to.have.header('Content-Security-Policy', 'connect-src \'self\' assets.adobedtm.com *.demdex.net *.hotjar.com:* *.google-analytics.com nhs.funnelback.co.uk *.search.windows.net; default-src \'self\'; font-src \'self\' *.nhs.uk *.hotjar.com; frame-src *.hotjar.com; img-src \'self\' data: *.2o7.net *.everesttech.net *.google-analytics.com *.hotjar.com *.nhs.uk *.omtrdc.net *.webtrends.com *.webtrendslive.com; script-src \'self\' \'unsafe-eval\' \'unsafe-inline\' data: assets.adobedtm.com *.demdex.net *.google-analytics.com *.hotjar.com *.nhs.uk *.webtrends.com *.webtrendslive.com; style-src \'self\' \'unsafe-inline\' *.nhs.uk; worker-src *.hotjar.com');
