...
((global) => {
  ...
  NHSUK.details = {
    ...
    addClickEvent: (node, callback) => {
      NHSUK.details.addEvent(node, 'keypress', (e, target) => {
        // When the key gets pressed - check if it is enter or space
        if (NHSUK.details.charCode(e) === NHSUK.details.KEY_ENTER
          || NHSUK.details.charCode(e) === NHSUK.details.KEY_SPACE) {
      ...
      NHSUK.details.addEvent(node, 'keyup', (e, target) => {
      ...
      NHSUK.details.addEvent(node, 'click', (e, target) => {
        callback(e, target);
      });
    },
    ...
    addDetailsPolyfill: (list, container) => {
      ...
      NHSUK.details.addClickEvent(container, (e, summary) => {
